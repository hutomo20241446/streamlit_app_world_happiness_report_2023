...
def saran_page():
    ...
    st.markdown("""
        ...
        <p>
            ...
            dan menaikkan pendapatan asli daerah. Meningkatnya pendapatan asli setiap daerah mengakibatkan peningkatan GDP
        </p>
        <p>
        ...
        <p>
            Toleransi perlu dikembangkan agar setiap orang dalam suatu komunitas tidak merasa terikat secara personal
